<?php
    ...
    switch($requestType){
        ...
        case "G":
            ...
            break;
        case "U":
            $SQL="SELECT u.username,s.score as points,s.play_date,(SELECT COUNT(*) FROM scores WHERE score>points) rank FROM scores s INNER JOIN users u ON s.user_id=u.idk_users WHERE u.idk_users =".$unpackedPacket[0]."";
